...
def view(sfen):
    #print(sfen)
    value = eval(sfen) if sfen.split(" ")[-3]=='b' else -eval(sfen)
    #print(value)
    return value
...
def main():
    ...
    # -873 orqha
    # -875 illqha2.1
    sfen ='1R4nnl/5bgk1/3p1gs+P1/2Plppp1p/l1G5S/4P3P/PK2+sP3/2G4R1/1N5NL w 7Pbs 88'
    #print(sfen,eval(sfen))
    view(sfen)
    view('ln6l/5g1k1/p3+P2pp/1ppP1sP2/3G5/4bB3/PP1+p3PP/4g1s2/L3K3L b 2RG2S2NPn4p 137')
    # 1952 orqha
    # 2096 illqha2.1
